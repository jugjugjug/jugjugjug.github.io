...
// This script fetches version information from two JSON files and displays the current version and a warning message if the user is not on the latest released version.
